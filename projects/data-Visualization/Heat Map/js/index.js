...
d3.json(dataURL, function (error, data) {
  ...
  scaleLinear().
  domain([
  d3.min(monthlyData, function (d) {return d.year;}),
  ...
  attr("data-month", function (d, i) {return d.month - 1;}).
  attr("data-year", function (d, i) {return d.year;}).
  attr("data-temp", function (d, i) {return d.variance + data.baseTemperature;}).
  ...
  function onMouseOver(d, i) {
    ...
    tooltip.html(function (d) {return "Year:" + monthlyData[i].year + "<br/>" +
    ...
    attr("data-year", function (d) {return monthlyData[i].year;});
  }
  ...
  append("rect").
  attr("y", "0.25em").
  attr("x", function (d, i) {return 0.25 + i * 3.25 + "em";}).
  attr("width", "1em").
  attr("height", "1em").
  ...
  append("text").
  attr("y", "1.0em").
  attr("x", function (d, i) {return 1.1 + i * 3.25 + 0.5 + "em";}).
  attr("font-size", "1em").
